...
class RadioTest {
    ...
    @Test
    public void testDownOneStation(){
        Radio radio = new Radio();
        radio.setDownRadioStation(1);
    ...
    @Test
    public void testDownZeroVolume() {
        Radio radio = new Radio();
    ...
    @Test
    public void testUpElenenVolume() {
        Radio radio = new Radio();
